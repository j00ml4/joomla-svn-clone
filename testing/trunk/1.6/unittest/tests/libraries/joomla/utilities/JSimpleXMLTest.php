...
class JSimpleXMLTest extends PHPUnit_Framework_TestCase
{
    ...
    {
		include_once dirname(dirname(dirname(dirname(dirname(__FILE__)))))
			. '/stubs/libraries/joomla/error/error.php';
		include_once dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))
			. '/libraries/joomla/utilities/simplexml.php';
        $this->object = new JSimpleXML( array(XML_OPTION_SKIP_WHITE => true) );
        JError::$exception = null;
    }
