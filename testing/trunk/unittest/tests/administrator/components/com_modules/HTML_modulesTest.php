 ...
 *
 * @TODO	Find a better place for static mocks (no support for static mocks in PHPUnit yet - needs PHP 5.3) to live
 */
class JHTML
{
	function _() {
...
class HTML_modulesTest extends PHPUnit_Framework_TestCase
{
	/**
	 * Faked client object.
	 *
