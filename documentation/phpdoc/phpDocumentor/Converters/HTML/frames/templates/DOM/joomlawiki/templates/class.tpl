...
| [[|##http://api.joomla.org/media/images/package.png qq]] [[references:{$package}|{$package}]] | [[|##http://api.joomla.org/media/images/package.png qq]] [[references:{$package}#{$subpackage}|{$subpackage}]] | [[http://api.joomla.org/{$package}/{$subpackage}/{$class_name}.html|{$class_name}]] | never | Work in progress |
...
| [[references:Joomla.Framework|##http://api.joomla.org/media/images/package.png qq]] [[references:{$package}|{$package}]] | [[|##http://api.joomla.org/media/images/package.png qq]] [[references:{$package}#{$subpackage}|{$subpackage}]] | [[{$class_name}|##http://api.joomla.org/media/images/Class.png qq]][[{$class_name}|{$class_name}]] | [[http://api.joomla.org/{$package}/{$subpackage}/{$class_name}.html|{$class_name}->{$methods[methods].function_name}]] | never | Work in progress |
