...
<div class="info-box">
	...
	<div class="nav-bar">
		...
		{if $vars || $ivars}
			{if $vars}
				<a href="#sec-var-summary">Variables</a> (<a href="#sec-vars">details</a>)
			{else}
				<a href="#sec-vars">Variables</a>
			{/if}
	...
	<div class="info-box-body">
		...
		{if $class_tree.classes}
		<pre class="class-tree">{section name=tree loop=$class_tree.classes}{$class_tree.classes[tree]}{$class_tree.distance[tree]}{/section}</pre>
		{/if}
	...
	<div class="info-box">
		...
		<div class="info-box-body">
			<table cellpadding="2" cellspacing="0" class="class-table">
				...
				<tr>
					<td class="class-table-data">
						<img src="{$subdir}media/images/{if $children[kids].abstract}Abstract{/if}{if $children[kids].access == 'private'}Private{/if}Class.png" alt="{if $children[kids].abstract}Abstract {if $children[kids].access == 'private'}private {/if}c{else}{if $children[kids].access == 'private'}Private c{else}C{/if}{/if}lass" title="{if $children[kids].abstract}Abstract {if $children[kids].access == 'private'}private {/if}c{else}{if $children[kids].access == 'private'}Private c{else}C{/if}{/if}lass" />{$children[kids].link}
					</td>
					<td>
		...
		<div class="info-box-body">
			<div class="const-summary">
				...
				<div class="const-title">
					...
					<a href="#{$consts[consts].const_name}" title="Details for this constant" class="const-name">{$consts[consts].const_name}</a> = 					<span class="var-type">{$consts[consts].const_value}</span>
	...
	<div class="info-box">
		...
		<div class="nav-bar">
			...
			{if $children}
				<a href="#sec-descendents">Descendants</a> |
			{/if}
			<span class="disabled">Variables</span> (<a href="#sec-vars">details</a>)
			{if $methods || $imethods}
				| 
				{if $methods}
					<a href="#sec-method-summary">Methods</a> (<a href="#sec-methods">details</a>)
		...
		<div class="info-box-body">
			<div class="var-summary">
				...
				{if $vars[vars].static}
				<div class="var-title">
					<img src="{$subdir}media/images/StaticVariable.png" alt="Static variable" title="Static variable" />
					static <span class="var-type">{$vars[vars].var_type}</span>
					<a href="#{$vars[vars].var_name}" title="Details for this variable" class="var-name">{$vars[vars].var_name}</a>
				</div>
				{/if}
				{/section}
				{section name=vars loop=$vars}
				{if !$vars[vars].static}
				<div class="var-title">
					<img src="{$subdir}media/images/{if $vars[vars].access == 'private'}PrivateVariable{else}Variable{/if}.png" alt="{if $vars[vars].access == 'private'}Private variable{else}Variable{/if}"  title="{if $vars[vars].access == 'private'}Private variable{else}Variable{/if}" />
		...
		<div class="info-box-body">			
			<div class="method-summary">
				...
				<div class="method-definition">
					<img src="{$subdir}media/images/StaticMethod.png" alt="Static method" title="Static method" />
					static {if $methods[methods].function_return}
						<span class="method-result">{$methods[methods].function_return}</span>
					{/if}
					<a href="#{$methods[methods].function_name}" title="Details for this method" class="method-name">{if $methods[methods].ifunction_call.returnsref}&amp;{/if}{$methods[methods].function_name}</a>
				...
				{if !$methods[methods].static}			
				<div class="method-definition">
					<img src="{$subdir}media/images/{if $methods[methods].ifunction_call.constructor}Constructor{elseif $methods[methods].ifunction_call.destructor}Destructor{elseif $methods[methods].access == 'private'}{if $methods[methods].abstract}Abstract{/if}PrivateMethod{else}{if $methods[methods].abstract}Abstract{/if}Method{/if}.png" 
						alt="{if $methods[methods].ifunction_call.constructor}Constructor{elseif $methods[methods].ifunction_call.destructor}Destructor{elseif $methods[methods].abstract}Abstract {if $methods[methods].access == 'private'}private {/if}method{elseif $methods[methods].access == 'private'}Private method{else}Method{/if}"
						title="{if $methods[methods].ifunction_call.constructor}Constructor{elseif $methods[methods].ifunction_call.destructor}Destructor{elseif $methods[methods].abstract}Abstract {if $methods[methods].access == 'private'}private {/if}method{elseif $methods[methods].access == 'private'}Private method{else}Method{/if}"/>
...
{if $vars || $ivars}
	...
	<div class="info-box">
		...
		<div class="nav-bar">
			...
			{/if}
			{if $methods}
				<a href="#sec-var-summary">Variables</a> (<span class="disabled">details</span>)
			{else}
				...
				{section name=ivars loop=$ivars}
					...
					<blockquote>
						{section name=ivars2 loop=$ivars[ivars].ivars}
							<img src="{$subdir}media/images/{if $ivars[ivars].ivars[ivars2].access == 'private'}PrivateVariable{else}Variable{/if}.png" alt="{if $ivars[ivars].ivars[ivars2].access == 'private'}Private variable{else}Variable{/if}" title="{if $ivars[ivars].ivars[ivars2].access == 'private'}Private variable{else}Variable{/if}" />
				...
				{section name=iconsts loop=$iconsts}
					...
					<blockquote>
						{section name=iconsts2 loop=$iconsts[iconsts].iconsts}
							<img src="{$subdir}media/images/{if $iconsts[iconsts].iconsts[iconsts2].access == 'private'}PrivateVariable{else}Variable{/if}.png" alt="{if $iconsts[iconsts].iconsts[iconsts2].access == 'private'}Private variable{else}Variable{/if}"  title="{if $iconsts[iconsts].iconsts[iconsts2].access == 'private'}Private variable{else}Variable{/if}" />
