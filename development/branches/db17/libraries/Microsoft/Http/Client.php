 ...
 * @see Microsoft_Uri
 */
require_once JPATH_LIBRARIES.'/Microsoft/Uri.php';


/**
 * @see Microsoft_Http_Client_Adapter_Interface
 */
require_once JPATH_LIBRARIES.'/Microsoft/Http/Client/Adapter/Interface.php';
 ...
 */
require_once JPATH_LIBRARIES.'/Microsoft/Http/Response/Stream.php';
...
class Microsoft_Http_Client
{
    ...
    public function setUri($uri)
    {
        ...
        if (!$uri instanceof Microsoft_Uri_Http) {
            ...
            require_once JPATH_LIBRARIES.'/Microsoft/Http/Client/Exception.php';
    ...
    public function setCookieJar($cookiejar = true)
    {
        if (! class_exists('Microsoft_Http_CookieJar')) {
            require_once JPATH_LIBRARIES.'/Microsoft/Http/CookieJar.php';
        }
    ...
    public function setCookie($cookie, $value = null)
    {
        if (! class_exists('Microsoft_Http_Cookie')) {
            require_once JPATH_LIBRARIES.'/Microsoft/Http/Cookie.php';
        }
