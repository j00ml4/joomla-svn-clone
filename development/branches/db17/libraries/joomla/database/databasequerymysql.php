...
class JDatabaseQueryMySQL extends JDatabaseQuery
{
	...
	{
		$this->type	= 'insert';
		$this->insert	= new JDatabaseQueryElementMySQL('INSERT INTO', $tables);
   ...
   function renameTable($table_name, &$db, $prefix = null, $backup = null)
   {
     $this->type = 'rename';
      ...
      if (is_null($this->rename)) {
        $this->rename = new JDatabaseQueryElementMySQL('RENAME TABLE', $table_name, ' TO ');
      }
      else {
   ...
   */
   function insertInto($table_name, $increment_field=false)
   {
     ...
     $this->insert_into = new JDatabaseQueryElementMySQL('INSERT INTO', $table_name);
   ...
   */
   function fields($fields)
   {
     if (is_null($this->fields)) {
      $this->fields = new JDatabaseQueryElementMySQL('(', $fields);
    }
    else {
   ...
   */
   function values($values)
   {
     if (is_null($this->values)) {
      $this->values = new JDatabaseQueryElementMySQL('VALUES (', $values);
    }
    else {
