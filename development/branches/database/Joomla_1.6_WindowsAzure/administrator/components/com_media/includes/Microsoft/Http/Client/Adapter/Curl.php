 ...
 */
require_once 'components/com_media/includes/Microsoft/Uri/Http.php';
 ...
 */
require_once 'components/com_media/includes/Microsoft/Http/Client/Adapter/Stream.php';
...
class Microsoft_Http_Client_Adapter_Curl implements Microsoft_Http_Client_Adapter_Interface, Microsoft_Http_Client_Adapter_Stream
{
    ...
    public function __construct()
    {
        if (!extension_loaded('curl')) {
            require_once 'components/com_media/includes/Microsoft/Http/Client/Adapter/Exception.php';
