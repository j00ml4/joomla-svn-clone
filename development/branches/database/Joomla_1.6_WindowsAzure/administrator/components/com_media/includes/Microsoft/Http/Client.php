 ...
 * @see Microsoft_Uri
 */
require_once 'components/com_media/includes/Microsoft/Uri.php';


/**
 * @see Microsoft_Http_Client_Adapter_Interface
 */
require_once 'components/com_media/includes/Microsoft/Http/Client/Adapter/Interface.php';
 ...
 */
require_once 'components/com_media/includes/Microsoft/Http/Response/Stream.php';
...
class Microsoft_Http_Client
{
    ...
    public function setUri($uri)
    {
        ...
        if (!$uri instanceof Microsoft_Uri_Http) {
            ...
            require_once 'components/com_media/includes/Microsoft/Http/Client/Exception.php';
    ...
    public function setCookieJar($cookiejar = true)
    {
        if (! class_exists('Microsoft_Http_CookieJar')) {
            require_once 'components/com_media/includes/Microsoft/Http/CookieJar.php';
        }
    ...
    public function setCookie($cookie, $value = null)
    {
        if (! class_exists('Microsoft_Http_Cookie')) {
            require_once 'components/com_media/includes/Microsoft/Http/Cookie.php';
        }
