...
) AUTO_INCREMENT=10000 CHARACTER SET utf8 ENGINE = InnoDB;
...
)  DEFAULT CHARSET=utf8 COMMENT='Available Updates' ENGINE = InnoDB;
...
)  DEFAULT CHARSET=utf8 COMMENT='Update Sites' ENGINE = InnoDB;
...
) ENGINE = MYISAM CHARACTER SET utf8 COMMENT = 'Links extensions to update sites' ENGINE = InnoDB;
...
)  DEFAULT CHARSET=utf8 COMMENT='Update Categories' ENGINE = InnoDB;
...
)  DEFAULT CHARSET=utf8 COMMENT='Simple user profile storage table' ENGINE = InnoDB;
