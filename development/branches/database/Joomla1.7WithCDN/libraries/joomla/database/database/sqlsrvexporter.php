...
class JDatabaseExporterSQLSrv
{
	...
	/**
	 * @var    JDatabaseSQLSrv  The database connector to use for exporting structure and/or data.
	 * @since  11.1
	 */
	protected $db = null;
	...
	public function check()
	{
		...
		if (!($this->db instanceof JDatabaseSQLSrv)) {
	 ...
	 *
	 * @param   JDatabaseSQLSrv  $db  The database connector.
	 *
	 * @return  JDatabaseExporterSQLSrv  Method supports chaining.
	 *
	 * @since   11.1
