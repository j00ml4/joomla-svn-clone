...
/**
 * SQLAzure import driver.
 *
 * @package     Joomla.Platform
 * @subpackage  Database
 * @since       11.1
 */
class JDatabaseImporterSQLAzure
{
	/**
	 ...
	 *
	 * @return  JDatabaseImporterSQLAzure
	 *
	 * @since   11.1
	 */
	 ...
	 *
	 * @return  JDatabaseImporterSQLAzure  Method supports chaining.
	 *
	 * @since   11.1
	 */
...
//						echo '</pre>';
	 ...
	 * @since   11.1
	 */
	public function setDbo(JDatabaseSQLSrv $db)
	{
		$this->db = $db;
