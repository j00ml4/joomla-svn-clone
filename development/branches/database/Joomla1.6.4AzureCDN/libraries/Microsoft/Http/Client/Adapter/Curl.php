 ...
 */
require_once JPATH_LIBRARIES.'/Microsoft/Uri/Http.php';
 ...
 */
require_once JPATH_LIBRARIES.'/Microsoft/Http/Client/Adapter/Stream.php';
...
class Microsoft_Http_Client_Adapter_Curl implements Microsoft_Http_Client_Adapter_Interface, Microsoft_Http_Client_Adapter_Stream
{
    ...
    public function __construct()
    {
        if (!extension_loaded('curl')) {
            require_once JPATH_LIBRARIES.'/Microsoft/Http/Client/Adapter/Exception.php';
