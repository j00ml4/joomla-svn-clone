...
<form action="<?php echo JRoute::_('index.php?option=com_languages&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="language-form" class="form-validate">
