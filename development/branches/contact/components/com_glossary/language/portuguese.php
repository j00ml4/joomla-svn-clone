...
if (!defined('_CMSAPI_NO')) define ('_CMSAPI_NO', 'Nуo');
if (!defined('_CMSAPI_CANCEL')) define ('_CMSAPI_CANCEL', 'Cancela');
if (!defined('_CMSAPI_CONFIG_COMP')) define ('_CMSAPI_CONFIG_COMP', 'Configuraчуo salva');
...
if (!defined('_GLOSSARY_TERM_CONTAINS')) define ('_GLOSSARY_TERM_CONTAINS', 'Contenha');
...
if (!defined('_GLOSSARY_GO')) define ('_GLOSSARY_GO', 'Busca');
...
if (!defined('_GLOSSARY_SHOW_ALPHABET')) define ('_GLOSSARY_SHOW_ALPHABET', 'Show the alphabet:');
...
if (!defined('_GLOSSARY_DESC_SHOW_ALPHABET')) define ('_GLOSSARY_DESC_SHOW_ALPHABET', 'Main glossary screen to show alphabet linking entries');
