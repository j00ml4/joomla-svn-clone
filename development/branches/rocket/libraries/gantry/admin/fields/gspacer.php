...
class JFormFieldGSpacer extends GantryFormField {
	...
	public function getGantryInput()
	{
		...
		$presetSaver = $this->element['preset-saver'];
		...
		$surroundOpens = "<div id='g-$this->element['name']' class='g-surround'>";
		$surroundClose = "</div>";
		$title = "<h3 class='g-title' rel='$this->element['name']'>".JText::_($this->element['glabel']).$saver."<span class='arrow'></span></h3>";
		$shadow = "<div class='g-title-shadow'></div>";
		$innerOpens = "<div id='g-$this->element['name']-inner' class='g-inner'>";
		$innerClose = "</div>";
