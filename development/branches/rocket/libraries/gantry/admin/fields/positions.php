...
class JFormFieldPositions extends JFormField {
	...
	protected function getInput(){
		...
		$posName = ($this->element['name'] == "mainbodyPosition") ? "sidebar" : str_replace("Position", "", $this->element['name']);
		...
		$scriptinit = $this->sliderInit($this->element['name']);	
		$document->addScriptDeclaration($scriptinit);
		
		
		$output = '
		<div class="wrapper">
		<div id="'.$this->element['name'].'" class="g-position">
			<div class="navigation">
				<span class="title">Positions:</span>
				<ul class="list">'.$lis.'</ul>
			</div>
			<div class="clr"></div>
			<div id="'.$this->element['name'].'-wrapper" class="col'.$this->maxGrid.' miniatures">
			...
			<div class="current-positions">
				<span class="title">'.str_replace('%d', "<strong class='".$this->element['name']."-currentPosition countPositions'>".$realCount."</strong>", JText::_('CURRENT_POSITIONS')).'</span>
			</div>
