<?php
/**
 * @version		$Id: default_item.php 14165 2010-01-14 11:06:43Z a.radtke $
 * @package		Joomla.Site
...
$params_template = new JParameter($app->getTemplate(true)->params);

if(!$params_template->get('html5', 0))
{
	require(JPATH_BASE.'/components/com_content/views/frontpage/tmpl/default_item.php');
