        ...
        if (!empty ($module->content)) : ?>
                <div class="moduletable<?php echo $params->get('moduleclass_sfx'); ?>">
                        <?php if ($module->showtitle) : ?>
                                <h<?php echo $headerLevel; ?>><span class="backh"><span class="backh2"><span class="backh3"><?php echo $module->title; ?></span></span></span></h<?php echo $headerLevel; ?>>
                        <?php endif; ?>
...
function modChrome_beezHide($module, &$params, &$attribs)
{
        ...
        if (!empty ($module->content)) : ?>
                ...
                <div class="moduletable_js <?php echo $params->get('moduleclass_sfx');?>" >
                        <?php if ($module->showtitle) : ?>
                                <h<?php echo $headerLevel; ?> class="js_heading"><span class="backh">
                                <span class="backh1"><?php echo $module->title; ?>
                                <a href="#" title="<?php echo JText::_('click'); ?>" onclick="auf('module_<?php echo $module->id; ?>'); return false" class="opencloselink" id="link_<?php echo $module->id?>">
                                <span class="no"><img src="templates/beez_20/images/plus.png" alt="<?php if($state==1){echo JText::_('ISOPEN');}else {echo JText::_('ISCLOSED');} ?>" />
                                </span></a></span></span></h<?php echo $headerLevel; ?>>
                        <?php endif; ?>
