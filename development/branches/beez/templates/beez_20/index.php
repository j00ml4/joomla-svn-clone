...
// check modules
$showRightColumn = ($this->countModules('position-7') or   $this->countModules('position-8'));
$showbottom=($this->countModules('position-9') or  $this->countModules('position-10') or   $this->countModules('position-11'));
$showleft=($this->countModules('position-3') or  $this->countModules('position-4') or   $this->countModules('position-6') or $this->countModules('position-5'));
                                ...
                                <?php if($navposition=='left' AND $showleft) : ?>
                                        ...
                                        <?php endif; ?>
                                        				<jdoc:include type="modules" name="position-6" style="beezDivision" headerLevel="3" />
                                                         <jdoc:include type="modules" name="position-3" style="beezHide" headerLevel="3" state="1" />
