...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
	<head>
		...
		<script type="text/javascript" src="<?php echo $this->baseurl ?>/templates/matuna/javascript/hide.js"></script>
		<script type="text/javascript" src="<?php echo $this->baseurl ?>/templates/matuna/javascript/html5.js"></script>

		<script type="text/javascript">
			var big ='<?php echo $this->params->get('wrapperLarge');?>%';
			var small='<?php echo $this->params->get('wrapperSmall'); ?>%';
			var altopen='<?php echo JText::_('TPL_MATUNA_ALTOPEN',true); ?>';
			var altclose='<?php echo JText::_('TPL_MATUNA_ALTCLOSE',true); ?>';
			var bildauf='<?php echo $this->baseurl ?>/templates/matuna/images/plus.png';
			var bildzu='<?php echo $this->baseurl ?>/templates/matuna/images/minus.png';
			var rightopen='<?php echo JText::_('TPL_MATUNA_TEXTRIGHTOPEN',true); ?>';
			var rightclose='<?php echo JText::_('TPL_MATUNA_TEXTRIGHTCLOSE'); ?>';
		</script>
				...
				<?php if ($showRightColumn) : ?>
					...
					<div id="close">
						<a href="#" onclick="auf('right')">
							<span id="bild">
								<?php echo JText::_('TPL_MATUNA_TEXTRIGHTCLOSE'); ?></span></a>
					</div>
