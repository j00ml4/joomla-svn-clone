...
if(!postlanguage) var postlanguage = {};

postlanguage.DEFAULT = {
  snippets: {
	"strong" : ["<strong>","something here","</strong>"],
	"em" : ["<em>","something here","</em>"],
...
postlanguage.BBCODE = {
  snippets: {
	"b" : ["[b]","something here","[/b]"],
	"i" : ["[i]","something here","[/i]"],
	"img" : ["[img]","http://","[/img]"],
	"quote" : ["[quote]\n	","something here","\n[/quote]"],
	"code" : ["[code=html]\n	","something here","\n[/code]"],
	"list" : {
