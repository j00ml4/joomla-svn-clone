 ...
 * <code>
 * 	<?php
 *	jimport('joomla.webservice.trackback');
 *	$trackback = new JTrackback({SITE_NAME}, {AUTHOR});
 *	?>
 * </code>
 *
 * @package		Joomle.Framework
 ...
 * @since		1.6
 */
class JTrackback extends JObject
{
	/**
     ...
     * @since	1.0
     */
    function __construct($site, $author = null)
    {
        $this->site		= $site;
        $this->author	= $author;
	...
	function send($target, $url, $title = "", $excerpt = "")
	{
		...
		$excerpt	= (empty($excerpt)) ? 'I found your entry interesting so I\'ve added a Trackback to it on my weblog' : $excerpt;
