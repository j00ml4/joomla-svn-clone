...
<?php if ($heading == 1 or $heading == 2) : ?>
		<img src="<?php echo $baseurl; ?>modules/mod_social_share/images/share-icon-16x16.gif" alt="<?php echo JText::_('MOD_SOCIAL_SHARE_Share_This');?>" />
<?php endif; ?>
		<?php if ($heading == 2 or $heading == 3) : ?>
		<span><?php echo JText::_('MOD_SOCIAL_SHARE_Share_This');?></span>
<?php endif; ?>
	</div>
<?php endif; ?>
...
<?php if ($params->get('sharing_delicious')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('delicious', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('DELICIOUS'));?>">
...
<?php
	...
	if ($params->get('sharing_furl')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('furl', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('FURL'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_yahoo')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('yahoo_myweb', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('YAHOO_MYWEB'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_google')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('google_bmarks', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('GOOGLE_BMARKS'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_blinklist')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('blinklist', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('BLINKLIST'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_magnolia')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('magnolia', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('MAGNOLIA'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_facebook')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('facebook', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('FACEBOOK'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_digg')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('digg', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('DIGG'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_stumbleupon')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('stumbleupon', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('STUMBLEUPON'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_technorati')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('technorati', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('TECHNORATI'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_newsvine')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('newsvine', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('NEWSVINE'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_reddit')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('reddit', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('REDDIT'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_tailrank')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('tailrank', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('TAILRANK'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php
	...
	if ($params->get('sharing_twitter')) : ?>
		<li>
			<a href="<?php echo modSocialShareHelper::getBookmark('twitter', $params); ?>" target="_blank" title="<?php echo JText::sprintf('MOD_SOCIAL_SHARE_Share_This_With', JText::_('TWITTER'));?>">
<?php if ($style == 0 or $style == 1) : ?>
...
<?php if ($params->get('sharing_email')) : ?>
	<div class="email">
		<?php echo JHtml::_('comments.email', JText::_('MOD_SOCIAL_SHARE_Email_Friend'), $params->get('link', modSocialShareHelper::getCurrentPageURL())); ?>
	</div>
<?php endif; ?>
</div>
