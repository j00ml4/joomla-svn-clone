...
<form id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=resend.resend'); ?>" method="post" class="form-validate">
...
<?php endforeach; ?>
	...
	<input type="hidden" name="task" value="member.resend" />
