...
class JFormFieldImpTotal extends JFormField
{
	...
	protected function getInput()
	{
		...
		return '<input type="text" name="'.$this->name.'" id="'.$this->id.'" value="'.htmlspecialchars($value, ENT_COMPAT, 'UTF-8').'" '.$class.$onchange.' /><input id="'.$this->id.'_unlimited" type="checkbox"'.$checked.$onclick.' /><input style="border:0;" type="text" value="'.JText::_('Banners_Unlimited').'" readonly="readonly"/>';
	}
}
