...
class ProjectsModelDocuments extends JModelList
{
    ...
    function getListQuery() {
        ...
        $query->select(
                $this->getState(
                        'list.select',
                        'a.id, a.title, a.alias, a.title_alias, a.state, a.catid, a.created, a.created_by, a.created_by_alias,a.access, ' .
...
//		$published = $this->getState('filter.published');
        ...
        $query->join('left', '#__project_contents AS pc ON pc.content_id=a.id');
        $query->where('pc.project_id = ' . $db->quote($app->getUserState('project.id')));
