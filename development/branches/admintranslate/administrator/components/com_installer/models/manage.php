		...
		foreach($result as $i => $row) {
			...
			switch ($row->type) {
				case 'component':
					...
					$lang->load("$extension.manage", JPATH_ADMINISTRATOR, null, false, false) || $lang->load($extension, JPATH_ADMINISTRATOR, null, false, false) || $lang->load("$extension.manage", $source, null, false, false) || $lang->load($extension, $source, null, false, false) || $lang->load("$extension.manage", JPATH_ADMINISTRATOR, $lang->getDefault(), false, false) || $lang->load($extension, JPATH_ADMINISTRATOR, $lang->getDefault(), false, false) || $lang->load("$extension.manage", $source, $lang->getDefault(), false, false) || $lang->load($extension, $source, $lang->getDefault(), false, false);
				break;
				case 'library':
					$extension = 'lib_' . $row->element;
					$lang->load("$extension.manage", JPATH_SITE, null, false, false) || $lang->load($extension, JPATH_SITE, null, false, false) || $lang->load("$extension.manage", JPATH_SITE, $lang->getDefault(), false, false) || $lang->load($extension, JPATH_SITE, $lang->getDefault(), false, false);
				break;
				case 'module':
					$extension = $row->element;
					$source = $path . '/modules/' . $row->name;
					$lang->load("$extension.manage", $path, null, false, false) || $lang->load($extension, $path, null, false, false) || $lang->load("$extension.manage", $source, null, false, false) || $lang->load($extension, $source, null, false, false) || $lang->load("$extension.manage", $path, $lang->getDefault(), false, false) || $lang->load($extension, $path, $lang->getDefault(), false, false) || $lang->load("$extension.manage", $source, $lang->getDefault(), false, false) || $lang->load($extension, $source, $lang->getDefault(), false, false);
				break;
				case 'package':
