	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="5%">
					<?php echo JHtml::_('grid.sort', 'JGrid_Heading_Enabled', 'enabled', $this->state->get('list.direction'), $this->state->get('list.ordering')); ?>
				</th>
				...
				<th width="1%" nowrap="nowrap">
					<?php echo JHtml::_('grid.sort', 'JGrid_Heading_ID', 'extension_id', $this->state->get('list.direction'), $this->state->get('list.ordering')); ?>
				</th>
			</tr>
		</thead>
		<tfoot>
