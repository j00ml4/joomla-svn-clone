...
abstract class JHtmlBehavior
{
	...
	public static function calendar()
	{
		...
		$uncompressed	= JFactory::getConfig()->get('debug') ? '-uncompressed' : '';
		JHtml::_('stylesheet','system/datepicker.css', array('media' => 'all'), true);
		JHtml::_('stylesheet','system/datepicker_dashboard/datepicker_dashboard.css', array('media' => 'all'), true);
		JHtml::_('script','system/mtcalendar'.'.js', false, true);
	 ...
	 * @since   11.1
	 */
	public static function _getJSObject($array=array())
	{
	...
	protected static function _calendartranslation()
	{
		...
		$locale = $doc->getLanguage();
		
		if (!$loaded) {
			$return = 'Locale.define(\''.$locale.'\', \'DatePicker\', {
	select_a_time: \''.JText::_('JLIB_HTML_BEHAVIOR_DATE_SELECTION', true).'\',
	use_mouse_wheel: \''.JText::_('JLIB_HTML_BEHAVIOR_USE_MOUSE_WHEEL', true).'\',
