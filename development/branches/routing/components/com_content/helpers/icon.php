...
class JHTMLIcon
{
	...
	static function email($article, $params, $attribs = array())
	{
		...
		if ($params->get('show_icons')) {
			$text = JHtml::image('system/emailButton.png', JText::_('Email'), NULL, true);
		} else {
			$text = '&nbsp;'.JText::_('Email');
		}
		...
		$output = JHtml::link(JRoute::_($url), $text, $attribs);
		return $output;
	}
	...
	static function edit($article, $params, $attribs = array())
	{
		...
		$text = JHtml::image('system/'.$icon, JText::_('Edit'), NULL, true);
		...
		$button = JHtml::link(JRoute::_($url), $text);
	...
	static function print_popup($article, $params, $attribs = array())
	{
		...
		if ($params->get('show_icons')) {
			$text = JHtml::image('system/printButton.png', JText::_('Print'), NULL, true);
		} else {
