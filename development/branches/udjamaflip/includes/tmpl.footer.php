    ...
    <div class="dock" id="dock">
        <div class="dock-container">
            <a class="dock-item" href="index.php?option=com_content" title="Article Manager" rel="900-550-10-10">
                <span>Article Manager</span><img src="templates/<?php echo  $this->template ?>/images/icons/Notes.png" alt="Article Manager" />
            </a>
			<a class="dock-item" href="index.php?option=com_menus" title="Menu Manager" rel="900-500-10-10">
                <span>Menu Manager</span><img src="templates/<?php echo  $this->template ?>/images/icons/StatusStyle.png" alt="Menu Manager" />
            </a>
			<a class="dock-item" href="index.php?option=com_massmail" title="Mass Mail" rel="900-500-10-10">
                <span>Mass Mail</span><img src="templates/<?php echo  $this->template ?>/images/icons/Mail.png" alt="Mass Mail" />
            </a>
			<a class="dock-item" href="index.php?option=com_media" title="Media Manager" rel="900-500-10-10">
                <span>Media Manager</span><img src="templates/<?php echo  $this->template ?>/images/icons/Categories.png" alt="Media Manager" />
            </a>
			<a class="dock-item" href="index.php?option=com_users&amp;task=view" title="User Manager" rel="900-500-10-10">
                <span>User Manager</span><img src="templates/<?php echo  $this->template ?>/images/icons/Contacts.png" alt="User Manager" />
            </a>
            <a class="dock-item" href="index.php?option=com_config" title="Global Configuration" rel="900-500-10-10">
            ...
            <a class="dock-item" href="index.php?option=com_modules" title="Module Manager" rel="900-500-10-10">
			...
			while ($i <= 5)
			{
				...
				{
					echo '<a class="dock-item" href="index.php?'.$this->params->get('customDockItem'.$i.'-url').'" title="'.$this->params->get('customDockItem'.$i.'-title').'" rel="900-500-10-10">
