...
<div class="width-50 fltrt helplinks">
	<ul class="helpmenu">
		<li><?php echo JHTML::_('link',JHelp::createUrl('Glossary', false, $remote), JText::_('COM_ADMIN_GLOSSARY'), array('target' => 'helpFrame')) ?></li>
		...
		<li><?php echo JHTML::_('link',JHelp::createUrl('Start_here'), JText::_('COM_ADMIN_START_HERE'), array('target' => 'helpFrame')) ?></li>
	</ul>
</div>
<div class="clr"> </div>
