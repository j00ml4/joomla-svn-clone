...
class JHTMLBehavior
{
	...
	function caption() {
		...
		JHTMLBehavior::framework();
		//JHTML::script('caption.js', 'plugins/system/mtupgrade/', false);
		JHTML::script('caption.js', 'media/system/js/', false);
	}

	function formvalidation() {
		// pass false to script so that we don't load the compatibility layer if we don't need it
		JHTMLBehavior::framework();
		//JHTML::script('validate.js', 'plugins/system/mtupgrade/', false);
	...
	function switcher() {
		// pass false to script so that we don't load the compatibility layer if we don't need it
		//JHTMLBehavior::framework();
		//JHTML::script('switcher.js', 'plugins/system/mtupgrade/', false);
	...
	function combobox() {
		// pass false to script so that we don't load the compatibility layer if we don't need it
		//JHTMLBehavior::framework();
		//JHTML::script('combobox.js', 'plugins/system/mtupgrade/', false);
	...
	function modal($selector='a.modal', $params = array())
	{
		...
		if (!isset($included)) {
			...
			JHTMLBehavior::framework();
			//JHTML::script('modal.js', 'plugins/system/mtupgrade/', false);
			JHTML::script('modal.js', 'media/system/js/', false);
 ...
 */
	...
	function tree($id, $params = array(), $root = array())
	{
		...
		// Include mootools framework
		JHTMLBehavior::framework();
		//JHTML::script('mootree.js', 'plugins/system/mtupgrade/', false);
		JHTML::script('mootree.js', 'media/system/js/', false);
	...
	function calendar()
	{
		...
		JHTMLBehavior::framework();
		JHTML::script( 'calendar.js', 'plugins/system/mtupgrade/', false);
		JHTML::script( 'calendar-setup.js', 'plugins/system/mtupgrade/', false);
